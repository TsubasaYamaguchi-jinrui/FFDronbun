...
$$
\begin{aligned}
&confirmed_{ijt} \sim Bernoulli(p_{ijt}) \\
 log\biggl(\frac{p_{ijt}}{1-p_{ijt}}\biggl) &= \beta_0 + \beta_1  t_{ijt} + \beta_2  t_{ijt}^2  + \beta_3  t^3_{ijt} +  \beta_4  nm19_{ijt} + \beta_5  m19_{ijt} + \beta_6  m20_{ijt} + \\ & \beta_7  nm21_{ijt} + \beta_8 m21_{ijt} + \beta_9 nm22_{ijt} + \beta_{10} rank\_std_{ijt} + \\& \beta_{11} age_std_{ij} + \gamma_i + \delta_j \\
&\gamma_i \sim Normal(0, \sigma_{\gamma}) \\
&\delta_j \sim Normal(0, \sigma_{\delta}) \\
\end{aligned}
$$
